...
const deletePlace = async (req, res, next) => {
    ...
    // If no place found, return a 404 error
    if (!place) {
    ...
    // Extract the image path for deletion
    ...
    try {
        ...
        // Remove the place document
        await place.deleteOne({ session: sess });
        //the remove method is no longer available in modern versions of Mongoose (v6+). Instead, you should use the deleteOne method or findByIdAndDelete for deletion.
